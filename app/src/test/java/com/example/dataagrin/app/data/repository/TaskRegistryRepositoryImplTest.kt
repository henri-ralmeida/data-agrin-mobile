...
class TaskRegistryRepositoryImplTest {
    ...
    private val fakeRegistries = listOf(
    ...
    @Test
    fun `getAllTaskRegistries should return flow of registries from dao`() = runBlocking {
    ...
    @Test
    fun `getAllTaskRegistries should return empty list when no data`() = runBlocking {
    ...
    @Test
    fun `insertTaskRegistry should call dao`() = runBlocking {
    ...
    @Test
    fun `insertTaskRegistry with modified flag should call dao correctly`() = runBlocking {
    ...
    @Test
    fun `insertTaskRegistry with deleted flag should call dao correctly`() = runBlocking {

...
class UpdateTaskUseCaseTest {
    ...
    @Test
    fun `invoke should call updateTask on repository`() =
        runBlocking {
    ...
    @Test
    fun `invoke should update task with new status`() =
        runBlocking {
    ...
    @Test
    fun `invoke should update task with all fields changed`() =
        runBlocking {
            val fullyUpdatedTask =
                Task(
                    id = 1,
                    name = "Updated Name",
                    area = "Updated Area",

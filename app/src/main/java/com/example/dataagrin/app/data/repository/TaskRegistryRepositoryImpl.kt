...
class TaskRegistryRepositoryImpl(private val taskRegistryDao: TaskRegistryDao) : TaskRegistryRepository {
    override fun getAllTaskRegistries(): Flow<List<TaskRegistry>> {
        return taskRegistryDao.getAllTaskRegistries()
    }
